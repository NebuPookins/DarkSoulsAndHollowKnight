...
| Elevators that you need to jump off of while it's moving | The elevator from Firelink Shrine to Undead Parish | The western elevator in City of Tears | Elevator Action has this as a core mechanic, but it's not treated as an "aha" moment the way it is in Dark Souls or Hollow Knight. Zelda does not use this trope. |
